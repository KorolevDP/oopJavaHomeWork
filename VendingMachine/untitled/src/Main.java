...
public class Main {
    public static void main(String[] args) throws Exception{
        ...
        // добавление продуктов уже в сам список
        assort.add(item1);
        assort.add(item2);
        assort.add(item3);
        assort.add(item4);
